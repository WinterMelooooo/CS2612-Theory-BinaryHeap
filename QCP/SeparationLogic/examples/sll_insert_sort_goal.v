...
forall (node_pre: Z) (p_pre: Z) (a: Z) (l: (@list Z)) (p2: Z) (l1: (@list Z)) (l2: (@list Z)) (p2_v: Z) ,
  [| (l = (app (l1) (l2))) |] 
...
forall (node_pre: Z) (a: Z) (l: (@list Z)) (p2: Z) (l1_2: (@list Z)) (l2_2: (@list Z)) (p2_v_2: Z) (x_81: Z) (l0_82: (@list Z)) (p2_v_next: Z) (p2_v_data: Z) (l3: (@list Z)) ,
...
forall (node_pre: Z) (a: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (p2_v: Z) (res: Z) ,
  [| (p2_v = 0) |] 
  &&  [| (l = (app (l1) (l2))) |] 
  &&  [| (strict_upperbound a l1 ) |] 
  &&  [| (node_pre <> 0) |]
...
forall (node_pre: Z) (a: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (p2_v: Z) (x_81: Z) (l0_82: (@list Z)) (y_83: Z) (res: Z) ,
  [| (x_81 >= a) |] 
  &&  [| (l2 = (cons (x_81) (l0_82))) |] 
  &&  [| (p2_v <> 0) |] 
  &&  [| (l = (app (l1) (l2))) |] 
...
forall (node_pre: Z) (a: Z) (l: (@list Z)) (p2: Z) (l1: (@list Z)) (l2: (@list Z)) (p2_v: Z) ,
  [| (p2_v <> 0) |] 
  &&  [| (l = (app (l1) (l2))) |] 
  &&  [| (strict_upperbound a l1 ) |] 
  &&  [| (node_pre <> 0) |]
...
forall (node_pre: Z) (p_pre: Z) (a: Z) (l: (@list Z)) (p2: Z) (l1: (@list Z)) (l2: (@list Z)) (p2_v: Z) (x_81: Z) (l0_82: (@list Z)) (y_83: Z) ,
  [| (x_81 < a) |] 
  &&  [| (l2 = (cons (x_81) (l0_82))) |] 
  &&  [| (p2_v <> 0) |] 
  &&  [| (l = (app (l1) (l2))) |] 
...
forall (node_pre: Z) (a: Z) (l: (@list Z)) (p2: Z) (l1: (@list Z)) (l2: (@list Z)) (p2_v: Z) (x_81: Z) (l0_82: (@list Z)) (y_83: Z) ,
  [| (x_81 < a) |] 
  &&  [| (l2 = (cons (x_81) (l0_82))) |] 
  &&  [| (p2_v <> 0) |] 
  &&  [| (l = (app (l1) (l2))) |] 
...
forall (l1: (@list Z)) (node: Z) (p2: Z) (p2_v: Z) ,
  [| (p2_v = node) |]
  &&  ((p2) # Ptr  |-> p2_v)
  **  (sllbseg ( &( "res" ) ) p2 l1 )
|--
