...
forall (q_pre: Z) (p_pre: Z) (X: (((@list Z) * (@list Z)) -> (unit -> Prop))) (p_pre_v: Z) (q_pre_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (q_v: Z) (p_v: Z) ,
...
forall (q_pre: Z) (p_pre: Z) (X: (((@list Z) * (@list Z)) -> (unit -> Prop))) (p_pre_v: Z) (q_pre_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (q_v: Z) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) ,
...
forall (q_pre: Z) (p_pre: Z) (X: (((@list Z) * (@list Z)) -> (unit -> Prop))) (p_pre_v: Z) (q_pre_v: Z) (x: Z) (l_2: (@list Z)) (l1_2: (@list Z)) (l2_2: (@list Z)) (q_v_2: Z) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) ,
  [| (x_next = 0) |] 
...
forall (q_pre: Z) (p_pre: Z) (X: (((@list Z) * (@list Z)) -> (unit -> Prop))) (p_pre_v_2: Z) (q_pre_v_2: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (q_v: Z) (p_v: Z) ,
  [| (x = 0) |] 
  &&  [| (safeExec ATrue (split_rec_rel (l) (l1) (l2)) X ) |] 
  &&  [| (q_pre_v_2 = 0) |] 
  &&  [| (p_pre_v_2 = 0) |]
...
forall (q_pre: Z) (p_pre: Z) (X: (((@list Z) * (@list Z)) -> (unit -> Prop))) (p_pre_v: Z) (q_pre_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (q_v: Z) (p_v: Z) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) ,
  [| (l = (cons (x_data) (l1_new))) |] 
  &&  [| (x <> 0) |] 
  &&  [| (safeExec ATrue (split_rec_rel (l) (l1) (l2)) X ) |] 
  &&  [| (q_pre_v = 0) |] 
...
forall (q_pre: Z) (p_pre: Z) (X: (((@list Z) * (@list Z)) -> (unit -> Prop))) (p_pre_v: Z) (q_pre_v: Z) (x: Z) (l: (@list Z)) (l1: (@list Z)) (l2: (@list Z)) (q_v: Z) (x_next: Z) (x_data: Z) (l1_new: (@list Z)) (y_166: Z) (x_next_2: Z) (x_data_2: Z) (l1_new_2: (@list Z)) ,
  [| (l1_new = (cons (x_data_2) (l1_new_2))) |] 
  &&  [| (x_next <> 0) |] 
  &&  [| (safeExec ATrue (bind ((split_rec_rel (l1_new) (l2) ((cons (x_data) (l1))))) (reversepair)) X ) |] 
  &&  [| (l = (cons (x_data) (l1_new))) |] 
