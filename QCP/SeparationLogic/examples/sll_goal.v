...
forall (x_pre: Z) (l2: (@list Z)) (l1: (@list Z)) (x_data: Z) (l1n: (@list Z)) (y: Z) (x: Z) (u: Z) (l1a: (@list Z)) (t: Z) (l1b: (@list Z)) (t_next: Z) (t_data: Z) ,
...
forall (x_pre: Z) (l2: (@list Z)) (l1: (@list Z)) (x_data: Z) (l1n: (@list Z)) (y: Z) (x: Z) (u: Z) (l1a_2: (@list Z)) (t: Z) (l1b_2: (@list Z)) (t_next_2: Z) (t_data_2: Z) (u_next: Z) (u_data: Z) (l1b_new: (@list Z)) ,
...
forall (x_pre: Z) (l2: (@list Z)) (l1: (@list Z)) (xn: Z) (a: Z) (l1b: (@list Z)) (y: Z) (x: Z) (u: Z) (t: Z) (l1a: (@list Z)) (b: Z) (l1c: (@list Z)) (t_next: Z) ,
...
forall (x_pre: Z) (l2: (@list Z)) (l1: (@list Z)) (xn: Z) (a: Z) (l1b: (@list Z)) (y: Z) (x: Z) (u: Z) (t: Z) (l1a_2: (@list Z)) (b_2: Z) (l1c_2: (@list Z)) (t_next_2: Z) (un: Z) (c: Z) (l1d: (@list Z)) ,
  [| (l1c_2 = (cons (c) (l1d))) |] 
  &&  [| (u <> 0) |] 
...
forall (l2: (@list Z)) (l1: (@list Z)) (y: Z) (pt: Z) (l1a_2: (@list Z)) (l1b_2: (@list Z)) (pt_v_2: Z) ,
  [| (pt_v_2 <> 0) |] 
  &&  [| ((app (l1a_2) (l1b_2)) = l1) |]
  &&  (sllbseg ( &( "x" ) ) pt l1a_2 )
  **  ((pt) # Ptr  |-> pt_v_2)
...
forall (l2: (@list Z)) (l1: (@list Z)) (y: Z) (l1a: (@list Z)) (l1b: (@list Z)) (pt_v: Z) (pres_v: Z) ,
  [| (pt_v = 0) |] 
  &&  [| ((app (l1a) (l1b)) = l1) |]
  &&  (sllseg pres_v y l1a )
  **  (sll pt_v l1b )
...
forall (l2: (@list Z)) (l1: (@list Z)) (y: Z) (pt: Z) (l1a: (@list Z)) (l1b: (@list Z)) (pt_v: Z) ,
  [| (pt_v = 0) |] 
  &&  [| ((app (l1a) (l1b)) = l1) |]
  &&  ((( &( "pres" ) )) # Ptr  |-> ( &( "x" ) ))
  **  ((( &( "pt" ) )) # Ptr  |-> pt)
...
forall (l1a: (@list Z)) (y: Z) (pt: Z) (pt_v: Z) (pres: Z) ,
  [| (pt_v = y) |]
  &&  ((pt) # Ptr  |-> pt_v)
  **  (sllbseg pres pt l1a )
|--
