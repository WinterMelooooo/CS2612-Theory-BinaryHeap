...
forall (y_pre: Z) (x_pre: Z) (b_pre: Z) (a_pre: Z) (x_pre_v: Z) (y_pre_v: Z) (retval: Z) ,
...
forall (y_pre: Z) (x_pre: Z) (b_pre: Z) (a_pre: Z) (x_pre_v_4: Z) (y_pre_v_4: Z) (retval: Z) ,
  [| (retval = (Zgcd (b_pre) ((a_pre % ( b_pre ) )))) |] 
...
|--
  ...
  **  ((y_pre) # Int  |->_))
  **
  (((EX x_pre_v_2 y_pre_v_2 retval_2,
  ...
  **  ((x_pre) # Int  |-> x_pre_v_2))
  ||
  (EX x_pre_v_3 y_pre_v_3 retval_2,
  [| (retval_2 = (Zgcd (a_pre) (b_pre))) |] 
  &&  [| (((a_pre * x_pre_v_3 ) + (b_pre * y_pre_v_3 ) ) = (Zgcd (a_pre) (b_pre))) |] 
  &&  [| (b_pre <> 0) |] 
  &&  [| ((a_pre % ( b_pre ) ) = 0) |] 
  ...
  **  ((x_pre) # Int  |-> x_pre_v_3))
  ||
  (EX x_pre_v_4 y_pre_v_4 retval_2,
  [| (retval_2 = (Zgcd (a_pre) (b_pre))) |] 
