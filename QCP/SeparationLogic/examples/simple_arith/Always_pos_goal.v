...
Definition Always_positive_entail_wit_3_1 := 
forall (c_pre: Z) (b_pre: Z) (a_pre: Z) ,
  [| (0 = 0) |] 
  &&  [| ((a_pre * c_pre ) <= 0) |] 
  &&  [| (a_pre <> 0) |] 
...
|--
  ...
  &&  [| ((b_pre * b_pre ) = (b_pre * b_pre )) |] 
  &&  [| ((a_pre * c_pre ) = (a_pre * c_pre )) |] 
  &&  [| ((b_pre * b_pre ) = (delta1 + ((4 - d ) * (a_pre * c_pre ) ) )) |] 
  &&  [| ((a_pre * c_pre ) > 0) |] 
  &&  [| (a_pre <> 0) |] 
  &&  [| (INT_MIN < a_pre) |] 
  &&  [| (a_pre <= INT_MAX) |] 
  ...
  &&  [| (INT_MIN < c_pre) |] 
  &&  [| (c_pre <= INT_MAX) |]
  &&  ((( &( "delta1" ) )) # Int64  |-> (delta1 - (a_pre * c_pre ) )))
.

Definition Always_positive_entail_wit_3_2 := 
forall (c_pre: Z) (b_pre: Z) (a_pre: Z) (delta1_2: Z) (delta2_2: Z) (delta0_2: Z) (d_2: Z) ,
  [| (d_2 = 0) |] 
  &&  [| (delta2_2 > delta1_2) |] 
  &&  [| (0 < d_2) |] 
  &&  [| (d_2 <= 4) |] 
  &&  [| (delta0_2 = (b_pre * b_pre )) |] 
  &&  [| (delta2_2 = (a_pre * c_pre )) |] 
  &&  [| (delta0_2 = (delta1_2 + ((4 - d_2 ) * delta2_2 ) )) |] 
  &&  [| ((a_pre * c_pre ) > 0) |] 
  &&  [| (a_pre <> 0) |] 
  &&  [| (INT_MIN < a_pre) |] 
  &&  [| (a_pre <= INT_MAX) |] 
  ...
  &&  [| (c_pre <= INT_MAX) |]
  &&  ((( &( "d" ) )) # Int  |-> d_2)
  **  ((( &( "delta0" ) )) # Int64  |-> delta0_2)
  **  ((( &( "delta2" ) )) # Int64  |-> delta2_2)
  **  ((( &( "delta1" ) )) # Int64  |-> delta1_2)
|--
  ([| (0 = 0) |] 
  &&  [| ((a_pre * c_pre ) <= 0) |] 
  &&  [| (a_pre <> 0) |] 
...
Definition Always_positive_entail_wit_3_3 := 
forall (c_pre: Z) (b_pre: Z) (a_pre: Z) (delta1_2: Z) (delta2_2: Z) (delta0_2: Z) (d_2: Z) ,
  [| (0 = 0) |] 
  &&  [| ((delta1_2 - delta2_2 ) >= 0) |] 
  &&  [| ((d_2 - 1 ) = 0) |] 
  ...
  &&  ((( &( "delta0" ) )) # Int64  |-> delta0_2)
  **  ((( &( "delta2" ) )) # Int64  |-> delta2_2)
  **  ((( &( "delta1" ) )) # Int64  |-> (delta1_2 - delta2_2 ))
|--
  ([| (0 = 0) |] 
  &&  [| ((a_pre * c_pre ) <= 0) |] 
  &&  [| (a_pre <> 0) |] 
...
Definition Always_positive_entail_wit_4_1 := 
forall (c_pre: Z) (b_pre: Z) (a_pre: Z) ,
  [| (0 <> 0) |] 
  &&  [| ((a_pre * c_pre ) <= 0) |] 
  &&  [| (a_pre <> 0) |] 
...
|--
  [| (0 <> 0) |] 
  &&  [| ((a_pre * c_pre ) > (b_pre * b_pre )) |] 
  &&  [| (0 < 0) |] 
  &&  [| (0 <= 4) |] 
  &&  [| ((b_pre * b_pre ) = (b_pre * b_pre )) |] 
  &&  [| ((a_pre * c_pre ) = (a_pre * c_pre )) |] 
  &&  [| ((b_pre * b_pre ) = ((b_pre * b_pre ) + ((4 - 0 ) * (a_pre * c_pre ) ) )) |] 
  &&  [| ((a_pre * c_pre ) > 0) |] 
  &&  [| (a_pre <> 0) |] 
  &&  [| (INT_MIN < a_pre) |] 
  &&  [| (a_pre <= INT_MAX) |] 
...
Definition Always_positive_entail_wit_4_2 := 
forall (c_pre: Z) (b_pre: Z) (a_pre: Z) (delta1: Z) (delta2: Z) (delta0: Z) (d: Z) ,
  [| (d <> 0) |] 
  &&  [| (delta2 > delta1) |] 
  &&  [| (0 < d) |] 
...
Definition Always_positive_entail_wit_4_3 := 
forall (c_pre: Z) (b_pre: Z) (a_pre: Z) (delta1: Z) (delta2: Z) (delta0: Z) (d: Z) ,
  [| (0 <> 0) |] 
  &&  [| ((delta1 - delta2 ) >= 0) |] 
  &&  [| ((d - 1 ) = 0) |] 
...
|--
  ...
  &&  [| (delta0 = (b_pre * b_pre )) |] 
  &&  [| (delta2 = (a_pre * c_pre )) |] 
  &&  [| (delta0 = ((delta1 - delta2 ) + ((4 - 0 ) * delta2 ) )) |] 
  &&  [| ((a_pre * c_pre ) > 0) |] 
  &&  [| (a_pre <> 0) |] 
  &&  [| (INT_MIN < a_pre) |] 
  &&  [| (a_pre <= INT_MAX) |] 
...
Axiom proof_of_Always_positive_entail_wit_3_1 : Always_positive_entail_wit_3_1.
Axiom proof_of_Always_positive_entail_wit_3_2 : Always_positive_entail_wit_3_2.
Axiom proof_of_Always_positive_entail_wit_3_3 : Always_positive_entail_wit_3_3.
Axiom proof_of_Always_positive_entail_wit_4_1 : Always_positive_entail_wit_4_1.
Axiom proof_of_Always_positive_entail_wit_4_2 : Always_positive_entail_wit_4_2.
Axiom proof_of_Always_positive_entail_wit_4_3 : Always_positive_entail_wit_4_3.
