...
forall (value_pre: Z) (x_pre: Z) (b_pre: Z) (tr: tree) (b: Z) (pt0: partial_tree) (tr0: tree) (b_v: Z) ,
...
forall (value_pre: Z) (x_pre: Z) (b_pre: Z) (tr: tree) (b: Z) (pt0: partial_tree) (tr0: tree) (b_v: Z) (retval: Z) ,
  [| (retval <> 0) |] 
  &&  [| (b_v = 0) |] 
  &&  [| ((combine_tree (pt0) ((tree_insert (x_pre) (value_pre) (tr0)))) = (tree_insert (x_pre) (value_pre) (tr))) |] 
  &&  [| (INT_MIN <= x_pre) |] 
...
forall (value_pre: Z) (x_pre: Z) (b_pre: Z) (tr: tree) (b: Z) (pt0_2: partial_tree) (tr0_2: tree) (b_v_2: Z) (p_right: Z) (p_left: Z) (l0: tree) (p_value: Z) (r0: tree) (p_key: Z) ,
  [| (x_pre < p_key) |] 
  &&  [| (INT_MIN <= p_key) |] 
  &&  [| (p_key <= INT_MAX) |] 
...
forall (value_pre: Z) (x_pre: Z) (b_pre: Z) (tr: tree) (b: Z) (pt0: partial_tree) (tr0: tree) (b_v: Z) (p_right: Z) (p_left: Z) (l0: tree) (p_value: Z) (r0: tree) (p_key: Z) ,
  [| (p_key >= x_pre) |] 
  &&  [| (x_pre >= p_key) |] 
  &&  [| (INT_MIN <= p_key) |] 
  &&  [| (p_key <= INT_MAX) |] 
