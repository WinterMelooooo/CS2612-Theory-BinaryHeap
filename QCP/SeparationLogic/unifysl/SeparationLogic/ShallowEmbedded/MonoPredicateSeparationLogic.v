...
Proof.
  constructor.
  + intros x.
    exact (@sound_sepcon_emp1 (MonoPred_L A) _ _ (Build_Model A) (unit_kMD _) tt R J U (MonoPred_SM A) (MonoPred_kiSM A) (MonoPred_kminSM A) (MonoPred_fsepconSM A) _ (MonoPred_empSM A) _ x).
  + intros x.
    exact (@sound_sepcon_emp2 (MonoPred_L A) _ _ (Build_Model A) (unit_kMD _) tt R J U (MonoPred_SM A) (MonoPred_kiSM A) (MonoPred_kminSM A) (MonoPred_fsepconSM A) _ (MonoPred_empSM A) _ x).
Qed.
