...
Proof.
  constructor.
  + intros x.
    exact (@sound_sepcon_emp1 (Pred_L A) _ _ (Build_Model A) (unit_kMD _) tt eq J U (Pred_SM A) (Pred_kiSM A) (Pred_kminSM A) (Pred_fsepconSM A) _ (Pred_empSM A) UJO_Rel x).
  + intros x.
    exact (@sound_sepcon_emp2 (Pred_L A) _ _ (Build_Model A) (unit_kMD _) tt eq J U (Pred_SM A) (Pred_kiSM A) (Pred_kminSM A) (Pred_fsepconSM A) _ (Pred_empSM A) UJO_Rel x).
Qed.
