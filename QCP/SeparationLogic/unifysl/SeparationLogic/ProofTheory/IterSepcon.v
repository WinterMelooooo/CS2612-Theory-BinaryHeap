...
Class IterSepconDeduction_left 
  ...
  {iter_sepcon_L : IterSepconLanguage L}
  (Gamma : Derivable1 L) := {
    iter_sepcon_d1_left1 : forall xs,
      iter_sepcon xs |-- fold_left sepcon xs emp;
    iter_sepcon_d1_left2 : forall xs,
      fold_left sepcon xs emp |-- iter_sepcon xs;
  }. 
...
Proof.
  ...
  + intros.
    ...
    apply iter_sepcon_d1_left1.
  + intros.
    apply derivable1_provable.
    apply iter_sepcon_d1_left2.
Qed.
