...
#[export] Instance sepcon_proper_impp: Proper ((fun x y => |-- impp x y) ==> (fun x y => |-- impp x y) ==> (fun x y => |-- impp x y)) sepcon.
Proof.
  hnf; intros x1 x2 ?.
  hnf; intros y1 y2 ?.
...
#[export] Instance wand_proper_impp: Proper ((fun x y => |-- impp x y) --> (fun x y => |-- impp x y) ==> (fun x y => |-- impp x y)) wand.
Proof.
  hnf; intros x1 x2 ?.
  hnf; intros y1 y2 ?.
...
#[export] Instance sepcon_proper_iffp: Proper ((fun x y => |-- iffp x y) ==> (fun x y => |-- iffp x y) ==> (fun x y => |-- iffp x y)) sepcon.
Proof.
  hnf; intros x1 x2 ?.
  hnf; intros y1 y2 ?.
...
#[export] Instance wand_proper_iffp: Proper ((fun x y => |-- iffp x y) ==> (fun x y => |-- iffp x y) ==> (fun x y => |-- iffp x y)) wand.
Proof.
  hnf; intros x1 x2 ?.
  hnf; intros y1 y2 ?.
  apply solve_iffp_intros.
...
#[export] Instance sepcon_proper_derivable1: Proper (derivable1 ==> derivable1 ==> derivable1) sepcon.
Proof.
  hnf;intros.
  hnf;intros.
...
#[export] Instance wand_proper_derivable1: Proper (derivable1 --> derivable1 ==> derivable1) wand.
Proof.
  hnf;intros.
  hnf;intros.
...
#[export] Instance sepcon_proper_logic_equiv: Proper (logic_equiv ==> logic_equiv ==> logic_equiv) sepcon.
Proof.
  hnf;intros.
  hnf;intros.
...
#[export] Instance wand_proper_logic_equiv: Proper (logic_equiv ==> logic_equiv ==> logic_equiv) wand.
Proof.
  hnf;intros.
  hnf;intros.
  apply logic_equiv_derivable1 in H;
...
#[export] Existing Instances sepcon_proper_impp
                             wand_proper_impp
                             sepcon_proper_iffp
                             wand_proper_iffp
