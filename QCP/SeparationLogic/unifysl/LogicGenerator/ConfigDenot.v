...
Definition rule_instances_build :=
  ...
  ; (cpSC, Build_ClassicalSequentCalculus L negpL GammaD derivable_by_contradiction)
  ...
  ; (expD, Build_ShallowExistsDeduction L expL GammaD1 shallow_exp_right shallow_exp_left)
  ; (allpD, Build_ShallowForallDeduction L allpL GammaD1 shallow_all_right shallow_all_left)
  ...
  ; (iter_sepcon_D1L, Build_IterSepconDeduction_left L sepconL empL iter_sepcon_L GammaD1 iter_sepcon_d1_left1 iter_sepcon_d1_left2)
  ...
  ; (coq_prop_D, Build_CoqPropDeduction L truepL coq_prop_L GammaD1 coq_prop_right coq_prop_left)
  ; (sap, Derived_sepcon_andp_prop)
  ; (sap_ext, Derived_sepcon_andp_prop_ext)
  ; (isap, Derived_iter_sepcon_andp_prop)
